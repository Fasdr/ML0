...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = np.multiply(output_layer_error, np.multiply(self.hidden_to_output_weights.transpose(),np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input)))
